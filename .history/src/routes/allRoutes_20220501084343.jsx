...
const userRoutes = [
  ...
  { path: "/update-subject/:id", component: UpdateSubject },

  { path: "/all-exams", component: AllExams },
  { path: "/add-exam", component: AddExam },
  { path: "/update-exam/:id", component: UpdateExam },
